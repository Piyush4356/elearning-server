...
import { isAdmin, isAdminOrTester, isAuth } from '../middleware/isAuth.js';
...
router.get("/stats",isAuth,isAdminOrTester,getAllStats);
router.put("/user/:id",isAuth,updateRole);
router.get("/users",isAuth,isAdminOrTester,getAllUser);
